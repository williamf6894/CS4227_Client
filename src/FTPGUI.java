...
public class FTPGUI extends JFrame {
    ...
    public FTPGUI() throws Exception {
        ...
        btnShow = new ShowImageButton(FTPGUI.SHOW);
        ...
        gbc.gridx = 4;
        gbc.gridy = 0;
        gridbag.setConstraints(btnShow, gbc);
        gbc.gridx = 5;
        gbc.gridy = 0;
    ...
    private void initialize() {
        // fill some test data from images folder
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            if (listOfFiles[i].isFile()) {
                ...
                defLocalList.addElement(listOfFiles[i].getName());
